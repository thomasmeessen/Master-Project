...
Muscular co-contraction is a well known mechanisms used by the body to stiffen his joints in order to improve it's stability and more generally to control it's movement.
...
From those studies it appear that both kinematic gait description and electromyography describe the same learning time taking approximately 30 min with the reached gait efficiency being conserved if reused a few day later.


Additional study have proposed the notion of gait stability based on the Lyaponov exponent [] or the temporal variation and explored the effect on muscular co-contraction.


## Burning the O2

Explaining and describing the metabolic cost of walk is a difficult task that go beyond accounting the mechanical energy exchange during walk.
One part of this cost is obviously related and described by the mechanical scenario created to explain the origin and effect of energy generated within the muscles during walk.
But 6DOF inverse kinematics do not apprehend the energy dissipated by soft tissues and muscles that are involved in co-contraction or isometric contraction as their do no generate work.
But those 02 expenditure have a non negligible impact as the case of the ankle during late stance demonstrate with the use of energy being stored and enabled trough isometric contraction.

So the mechanical accounting do not necessary deliver the dominant energy expanse during walk and other factors should be studied such as the stability of the gait and the mechanisms used by the ankle.
# Other joints

Total of 40 J of work for a stride

Using the same 6DOF inverse dynamic on a treadmill technique used for the ankle the force at the hip joint have been identified.
